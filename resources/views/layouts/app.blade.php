...
<body class="bg-[#09090B] text-white font-sans antialiased">
    ...
    @if(session('success'))
        <div id="toast" class="fixed bottom-6 left-6 z-50 bg-green-500/10 border border-green-500/20 text-green-400 rounded-xl px-5 py-3 shadow-2xl flex items-center gap-3 text-sm cursor-pointer" onclick="this.remove()">
    ...
    @if(session('error'))
        <div id="toast-error" class="fixed bottom-6 left-6 z-50 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl px-5 py-3 shadow-2xl flex items-center gap-3 text-sm cursor-pointer" onclick="this.remove()">
